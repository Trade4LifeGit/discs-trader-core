...
To build the final jar and optimize the DiscsTraderCore application for production, run:
...
[Swagger internal api documentation](http://localhost:8081//swagger-ui.html)
